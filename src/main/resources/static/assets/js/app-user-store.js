...
app.config(function ($routeProvider){
	...
	.when("/category__management", {
		templateUrl: "/assets/user_store/manage/category_management.html",
		controller: "category__management-ctrl"
	})
	// Đơn hàng
